...
use Yazor\MinecraftProtocol\Data\Identifier;
...
class ServerMethod
{
    ...
    private function __construct(public readonly Identifier $identifier, private(set) array $expectedClasses = [])
    {
     ...
     */
    public static function create(Identifier $identifier, array $expectedClasses = []): object {
        return new self($identifier, $expectedClasses);
    }
    ...
    public function withPath(ProtocolPath|string $path, array $expectedClasses = []): object {
        ...
        $location = $this->identifier->withParam($path);
    ...
    public static function initiate(): void
    {
        self::$ALLOWLIST = self::create(
            Identifier::read("minecraft:allowlist"), ['class' => MinecraftPlayer::class, 'list' => true]
        );
        ...
        self::$SERVER = self::create(Identifier::read("minecraft:server"))
        ...
        self::$PLAYERS = self::create(Identifier::read("minecraft:players"), ['class' => MinecraftPlayer::class, 'list' => true])
